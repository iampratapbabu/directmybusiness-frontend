      ...
      <header id="header" className="header fixed-top d-flex align-items-center">
        ...
        <div className="d-flex align-items-center justify-content-between">
          <div className="logo d-flex align-items-center justify-content-center">
            <a href="index.html" className="width-min-content">
              <img src="./assets/images/logo/dark-logo.png" alt=""/>
                {/* <!-- <span className="d-none d-lg-block">Virtual to Actual</span> --> */}
            </a>
          </div>
          ...
          <ul className="d-flex align-items-center">
            ...
            <li className="nav-item dropdown pe-3">
              ...
              <a className="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                <img src="./assets/images/profile-img.jpg" alt="Profile" className="rounded-circle"/>
